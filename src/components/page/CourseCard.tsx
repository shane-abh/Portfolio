const CourseCard = () => {
  return (
    <div className="w-full max-w-[1030px] px-8 py-10 md:place-items-center flex flex-col items-start space-y-3 bg-gradient-to-b from-white to-[rgba(5,0,255,0.7)]  hover:bg-blue-400 rounded-lg shadow-lg transition-colors duration-300 ease-in-out">
      <div className="w-full  md:max-w-screen-md space-y-[30px]">
        ...
        <p className="text-lg text-black w-full md:max-w-[620px] font-body">
          Discover my journey through the Cognizant and Udacity program,
          mastering Java fundamentals, advanced programming, and API
          development, showcased in impactful projects like a hotel reservation
          system, a multi-threaded web crawler, and a microservice-powered car
          inventory API.
        </p>
